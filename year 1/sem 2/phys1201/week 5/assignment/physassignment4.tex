...
squaring both sides and defining the threshold condition for $v_\mu^{min}$:
...
$$1 - \frac{(v_\mu^{min})^2}{c^2} = \frac{\tau_n^2}{\tau_\mu^2}$$
$$\frac{(v_\mu^{min})^2}{c^2} = 1 - \frac{\tau_n^2}{\tau_\mu^2}$$  
$$\frac{v_\mu^{min}}{c} = \sqrt{1 - \frac{\tau_\mu^2}{\tau_n^2}}$$
since $\tau_n \gg \tau_\mu$, $\frac{\tau_\mu^2}{\tau_n^2}$ is much less than 1. applying binomial approximation ($\sqrt{1 - x} \approx 1 - \frac{1}{2}x \quad \text{for } x \ll 1$):
substitute $x = \frac{\tau_\mu^2}{\tau_n^2}$,
$$\frac{v_\mu^{min}}{c} \approx 1 - \frac{1}{2}\left(\frac{\tau_\mu^2}{\tau_n^2}\right)$$
$$1 - \frac{v_\mu^{min}}{c} \approx \frac{1}{2}\left(\frac{\tau_\mu^2}{\tau_n^2}\right)$$
