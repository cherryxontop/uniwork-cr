...
\section{part 6}
Using the inverse Lorentz transformation from $S''$ to $S$:
$$t_B = \gamma_\mu \left( t_B'' + \frac{v_\mu x_B''}{c^2} \right)$$
...
squaring both sides and switching in $v_\mu^{min}$:
$$\frac{\tau_n^2}{1 - \frac{v_n^2}{c^2}} = \frac{\tau_\mu^2}{1 - \frac{(v_\mu^{min})^2}{c^2}}$$  
rearranging:
$$1 - \frac{(v_\mu^{min})^2}{c^2} = \left(\frac{\tau_n}{\tau_\mu}\right)^2 \left(1 - \frac{v_n^2}{c^2}\right)$$  
assuming the neutron is at rest in $S'$ and setting $v_n = 0$,
$$1 - \frac{(v_\mu^{min})^2}{c^2} = \left(\frac{\tau_n}{\tau_\mu}\right)^2$$
$$\frac{(v_\mu^{min})^2}{c^2} = 1 - \left(\frac{\tau_n}{\tau_\mu}\right)^2$$  
$$\frac{v_\mu^{min}}{c} = \sqrt{1 - \left(\frac{\tau_n}{\tau_\mu}\right)^2}$$
since $\tau_n \gg \tau_\mu$, $\left(\frac{\tau_n}{\tau_\mu}\right)^2$ is much less than 1. applying binomial approximation ($\sqrt{1 - x} \approx 1 - \frac{1}{2}x \quad \text{for } x \ll 1$):
substitute $x = \left(\frac{\tau_n}{\tau_\mu}\right)^2$,
$$\frac{v_\mu^{min}}{c} \approx 1 - \frac{1}{2}\left(\frac{\tau_n}{\tau_\mu}\right)^2$$
$$1 - \frac{v_\mu^{min}}{c} \approx \frac{1}{2}\left(\frac{\tau_n}{\tau_\mu}\right)^2$$
given $\tau_n \simeq 879.4 \text{ s}$ and $\tau_\mu \simeq 2.2 \times 10^{-6} \text{ s}$,
$$1 - \frac{v_\mu^{min}}{c} \simeq \frac{1}{2}\left(\frac{(2.2 \times 10^{-6})^2}{(879.4)^2}\right)$$
