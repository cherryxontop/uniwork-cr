...
## Experiment 1
The aim of this experiment is to measure the period of a simple pendulum with respect to some initial angle to highlight the connection between angle, oscillatory period, and the local acceleration due to gravity.
